...
const NewGuestPage: React.FC = () => {
  ...
  const [formData, setFormData] = useState<GuestFormData>({
    // NOTE: Replace this placeholder with a dynamic business unit ID from your application context
    businessUnitId: 'placeholder-business-unit-id',
    title: '',
    firstName: '',
    lastName: '',
    email: '',
    ...
    loyaltyNumber: '',
    vipStatus: false,
    marketingOptIn: true, // Default to true as per your schema
    source: '',
    notes: '',
  });
