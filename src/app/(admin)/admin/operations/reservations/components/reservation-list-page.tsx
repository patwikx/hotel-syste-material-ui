...
import { confirmReservation, cancelReservation } from '../../../../../../../lib/cms-actions/reservation-management';
    ...
    try {
      ...
      if (result.success) {
        setReservations(prev => prev.map(r => 
          r.id === actionDialog.reservation!.id 
            ? { ...r, isConfirmed: true, status: 'CONFIRMED' } 
            : r
        ));
        setSnackbar({
          open: true,
                  ...
                  <Box sx={{ flex: 1 }}>
                    <Stack spacing={2}>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Typography variant="body2" sx={{ color: '#6b7280' }}>
                          {reservation.numberOfGuests} guests ({reservation.numberOfAdults} adults, {reservation.numberOfChildren} children)
                        </Typography>
                      </Box>
                    </Stack>
                  </Box>
      ...
      >
        ...
        <DialogActions sx={{ p: 3, pt: 1 }}>
          ...
          <Button
            ...
            variant="contained"
            disabled={loading === actionDialog.action}
            sx={{
